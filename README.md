...
**FreeTO** utilizes other open-source codes such as [intriangulation.m](https://www.mathworks.com/matlabcentral/fileexchange/43381-intriangulation-vertices-faces-testp-heavytest) by Johannes Korsawe, and modifications in [top3D.m](https://www.top3d.app/) by Liu and Tovar, [SEMDOT.m](https://blogs.deakin.edu.au/dot/software/) by Fu et al., and [phi2stl.m](https://asmedigitalcollection.asme.org/computingengineering/article/17/4/041012/474348/An-Open-Source-Framework-for-Integrated-Additive) by Vogiatzis et al. FreeTO currently uses the optimality criteria method (OCM) but works much better with the Method of Moving Asymptotes (MMA) as optimizer. The implementation of MMA is given in SIMP.m and SEMDOT.m but the lines are commented out as the codes are not on this repository and must be requested for by the user from [Prof. Krista Svanberg](https://people.kth.se/~krille/Welcome.html) by email. 
